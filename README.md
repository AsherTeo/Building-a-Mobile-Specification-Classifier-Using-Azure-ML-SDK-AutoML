...
The Mobile Price Classification Dataset from [Kaggle](https://www.kaggle.com/datasets/iabhishekofficial/mobile-price-classification) which contains mobile phone specifications and their corresponding price ranges. The dataset includes features such as battery power, RAM, internal memory, camera resolutions, screen size, and whether the phone supports 4G.
